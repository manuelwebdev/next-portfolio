    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Overlay className="fixed bottom-0 left-0 right-0 top-0 grid items-center justify-end bg-[rgba(0,0,0,0.5)]">
          <Dialog.Content className="DialogContent grid h-[100dvh] w-[90dvw] min-w-[250px] grid-rows-[min-content_auto] overflow-y-auto rounded-l-md bg-white pb-20 duration-300 md:w-[80dvw]">
